...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-11">
                <div class="card">
                    <div class="card-header fs-1 text-center">未登録ユーザ トップ画面</div>
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    <tbody>
                                        @foreach ($template_folders as $template_folder)
                                            <tr>
                                                ...
                                                <td><a
                                                        href="{{ route('guest.template_task.show', $template_folder->id) }}">{{ $template_folder->name }}</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                            ...
                            <div class="col-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="GET" action="{{ route('guest.top.index') }}">
                                            <div class="mb-3">
                                                <label for="template_folder_name" class="form-label">フォルダー検索</label>
